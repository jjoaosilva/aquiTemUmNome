...
class PallettesRepository: Codable {
    ...
    func createNewItem(primaryColor: UIColor, secondaryColor: UIColor, thirdColor: UIColor, fourthColor: UIColor, fifthColor: UIColor, price: Int = 50, boughtState: Bool = false) -> ColorPallette {
        let newItem = ColorPallette(primaryColor: primaryColor, secondaryColor: secondaryColor, thirdColor: thirdColor, fourthColor: fourthColor, fifthColor: fifthColor, price: price, boughtState: boughtState)
